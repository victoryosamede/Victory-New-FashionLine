...
namespace FashionLine.DB
{
    public class FluentNHibernateHelper
    {
        ...
        private static string _connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\hp\OneDrive\Desktop\FashionLineDB.mdf;Integrated Security=True;Connect Timeout=30";
